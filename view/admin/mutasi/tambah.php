        ...
        <div class="col-lg-12 col-md-12 col-12 my-3">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div class="mb-2 mb-lg-0">
                    <h4 class="mb-0"><i class="fas fa-arrow-right-arrow-left me-2"></i>Tambah Data Mutasi Jabatan</h4>
                </div>
                <div>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control bg-light" id="nm_personil" required readonly>
