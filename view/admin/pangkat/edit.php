...
$id = $_GET['id'];
$query = $con->query("SELECT * FROM pangkat WHERE id_pangkat ='$id'");
        ...
        <div class="col-lg-12 col-md-12 col-12 my-3">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div class="mb-2 mb-lg-0">
                    <h4 class="mb-0"><i class="fas fa-award me-2"></i>Edit Data Pangkat</h4>
                </div>
                <div>
            ...
            <div class="card card-body border border-dark-danger">
                <form class="form-horizontal needs-validation" novalidate method="POST" action="" enctype="multipart/form-data">
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="nm_pangkat" value="<?= $row['nm_pangkat'] ?>" required>
...
if (isset($_POST['submit'])) {
    ...
    $update = $con->query("UPDATE pangkat SET 
        nm_pangkat = '$nm_pangkat'
        WHERE id_pangkat = '$id'
    ");
