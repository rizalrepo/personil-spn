...
if ($bulan == $cekbulan && $tahun == $cektahun) {
    $sql = mysqli_query($con, "SELECT * FROM cuti a LEFT JOIN personil b ON a.id_personil = b.id_personil LEFT JOIN pangkat c ON b.id_pangkat = c.id_pangkat LEFT JOIN jabatan d ON b.id_jabatan = d.id_jabatan WHERE MONTH(tgl_mulai) = '$bulan' AND YEAR(tgl_mulai) = '$tahun' ORDER BY tgl_mulai ASC");

    $label = 'LAPORAN DATA CUTI PERSONIL <br> Bulan : ' . $bln[date($bulan)] . ' ' . $tahun;
} else {
    $sql = mysqli_query($con, "SELECT * FROM cuti a LEFT JOIN personil b ON a.id_personil = b.id_personil LEFT JOIN pangkat c ON b.id_pangkat = c.id_pangkat LEFT JOIN jabatan d ON b.id_jabatan = d.id_jabatan ORDER BY tgl_mulai DESC");
    $label = 'LAPORAN DATA CUTI PERSONIL';
}
