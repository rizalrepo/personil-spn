...
<body class="bg-light">
    ...
    <div class="container-fluid">
        <div class="card card-body border border-dark-danger mt-2">
            <div class="row">
                <form id="form-absen-pulang" action="" method="POST" enctype="multipart/form-data">
                    <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                        <input type="hidden" name="foto_pulang" class="img-pulang">
                    ...
                    <div class="d-grid mt-2">
                        <button type="submit" name="pulang" class="btn bg-dark-primary text-white"><i class="fas fa-id-card-alt me-1"></i> Absensi Pulang</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script>
        ...
        $("#form-absen-pulang").submit(function() {
...
if (isset($_POST['pulang'])) {
    ...
    $img = $_POST['foto_pulang'];
    $folderPath = "../../../storage/pulang/";
    ...
    $foto_pulang = uniqid() . '.png';

    $file = $folderPath . $foto_pulang;
    ...
    $update = $con->query("UPDATE absensi SET  
        ...
        lat_pulang = '$_POST[lat]',
        lng_pulang = '$_POST[lng]',
    ...
    if ($update) {
        echo "
            <script>
                Swal.fire('Absen Pulang Berhasil !', '', 'success').then(function(){
                    window.close();
        ...
        echo "
            <script>
                Swal.fire('Absen Pulang Gagal !', '', 'error').then(function(){
                    <meta http-equiv='refresh' content='0; url=absen-pulang'>
                });
            </script>
        ";
    }
